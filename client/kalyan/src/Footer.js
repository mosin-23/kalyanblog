              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  {[
                    {
                      name: 'youtube',
                      path: 'M19.615 3.184C20.403 3.39 21.05 4.037 21.256 4.825c.384 1.472.384 4.541.384 4.541s0 3.07-.384 4.541c-.206.788-.853 1.435-1.641 1.641C18.143 16 12 16 12 16s-6.143 0-8.615-.448C2.597 15.345 1.95 14.698 1.744 13.91 1.36 12.438 1.36 9.37 1.36 9.37s0-3.07.384-4.541C1.95 4.04 2.597 3.393 3.385 3.187 5.857 2.74 12 2.74 12 2.74s6.143 0 7.615.444zM9.75 11.832l5.25-2.463-5.25-2.463v4.926z'
                    },
                    { 
                      name: 'X',
